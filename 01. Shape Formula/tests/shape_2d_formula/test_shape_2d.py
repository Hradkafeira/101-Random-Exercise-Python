import pytest
from shape.shape_2d_formula.shape_2d import Shape2DFormula as sd
...
class TestSquare(object):
	...
	def test_square_normal3(self):		
		actual = sd.square(-1.5)
		expected = False
		assert actual == expected, message

	def test_square_normal4(self):		
		actual = sd.square(-1.-5)
		expected = False
		assert actual == expected, message

	def test_square_normal5(self):		
		actual = sd.square(1.-5)
		expected = False
		assert actual == expected, message
...
class TestTriangle(object):
	...
	def test_triangle_normal3(self):
		actual = sd.triangle(-2,3)
		expected = False
		assert actual == expected, message

	def test_triangle_normal4(self):
		actual = sd.triangle(2,-3)
		expected = False
		assert actual == expected, message

	def test_triangle_normal5(self):
		actual = sd.triangle(-2,-3)
		expected = False
		assert actual == expected, message
...
class TestRectangle(object):
	...
	def test_rectangle_normal3(self):		
		actual = sd.rectangle(-3,4)
		expected = False
		assert actual == expected, message

	def test_rectangle_normal4(self):		
		actual = sd.rectangle(3,-4)
		expected = False
		assert actual == expected, message

	def test_rectangle_normal5(self):		
		actual = sd.rectangle(-3,-4)
		expected = False
		assert actual == expected, message
...
class TestParrallelogram(object):
	...
	def test_parallelogram_normal3(self):
		actual = sd.parallelogram(-20,10)
		expected = False
		assert actual == expected, message

	def test_parallelogram_normal4(self):
		actual = sd.parallelogram(20,-10)
		expected = False
		assert actual == expected, message

	def test_parallelogram_normal5(self):
		actual = sd.parallelogram(-20,-10)
		expected = False
		assert actual == expected, message
...
class TestTrapezium(object):
	...
	def test_trapezium_normal3(self):		
		actual = sd.trapezium(-4,4,3)
		expected = False
		assert actual == expected, message

	def test_trapezium_normal4(self):		
		actual = sd.trapezium(-4,-4,3)
		expected = False
		assert actual == expected, message

	def test_trapezium_normal5(self):		
		actual = sd.trapezium(-4,-4,-3)
		expected = False
		assert actual == expected, message

	def test_trapezium_normal6(self):		
		actual = sd.trapezium(4,-4,-3)
		expected = False
		assert actual == expected, message

	def test_trapezium_normal7(self):		
		actual = sd.trapezium(4,4,-3)
		expected = False
		assert actual == expected, message
